...
public class UF_HWQUPC implements UF {
    ...
    private static void countConnections(int n) {
        ...
        while (uf.components() != 1) {
            int a = (int) (rd.nextInt(n));
            int b = (int) (rd.nextInt(n));
        ...
        System.out.println("No Of Objects " +n + " No Of Pairs" + " "+noOfPairs+" and "+"Connections "+noOfConnections);
